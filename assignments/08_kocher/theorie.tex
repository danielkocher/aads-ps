...
\begin{center}
$\phi(D_i)=2i-2^{\lfloor{ld(i-1)}\rfloor+1}+1$
\end{center}
Für alle Operationen i mit $i=2^k+1$ gilt also: \\
\begin{center}
$\phi(D_i)=2i-2^{\lfloor{ld(i-1)}\rfloor+1}+1=2i-(2(i-1))+1=3$
\end{center}
Für alle Operationen i mit $i!=2^k+1$ gilt : \\
\begin{center}
...
=i+(2i-(2(i-1))+1)-(2(i-1)-(i-1)+1)\\
=i+(2i-2i+2+1)-(2(i-1)-(i-1)+1)\\
=i+3-i\\
=3
\end{align*}
\item Für alle Operationen i mit $i!=2^k+1$:\\
