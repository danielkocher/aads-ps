...
$2\cdot\text{log}_2 n$. Entfernt man nun das Minimum ($3$), dann verbleiben $n = 8$
Knoten. Wir ben{\"o}tigen daher ein Array der Gr{\"o}{\ss}e
$2\cdot\text{log}_2 8 = 2\cdot 3 = 6$.
...
eingef{\"u}gt wurde, d.h. $13$, $21$, $7$, $15$, $18$, $8$, $14$ und $27$).

\begin{figure}[H]
  \centering
  \begin{tikzpicture}[trim left=-6cm, scale=0.9, every node/.style={scale=0.9}]
    \node[elem] (e-7) {$7$};
    \node[elem, below left = 1.5 and 3 of e-7] (e-15) {$15$};
    \node[elem, below = 1.225 of e-7] (e-8) {$8$};
    \node[elem, below right = 1.5 and 3 of e-7] (e-13) {$13$};
    \node[elem, below = 1.225 of e-8] (e-18) {$18$};
    \node[elem, below left = 1.5 and 0.5 of e-13] (e-21) {$21$};
    \node[elem, below right = 1.5 and 0.5 of e-13] (e-14) {$14$};
    \node[elem, below = 1 of e-14] (e-27) {$27$};
    ...
    \path[pointer-parent] (e-15.north east) edge[bend right] (e-7.south west);
    \path[pointer-child] (e-8.south) edge[bend right] (e-18.north);
    \path[pointer-parent] (e-8.north) edge[bend right] (e-7.south);
    \path[pointer-parent] (e-18.north) edge[bend right] (e-8.south);
    \path[pointer-parent] (e-13.north west) edge[bend left] (e-7.south east);
    \path[pointer-child] (e-13.south west) edge[bend right] (e-21.north);
    \path[pointer-parent] (e-21.north) edge[bend right] (e-13.south west);
    \path[pointer-parent] (e-14.north) edge[bend right] (e-13.south east);
    \path[pointer-child] (e-14.south) edge[bend right] (e-27.north);
    \path[pointer-parent] (e-27.north) edge[bend right] (e-14.south);
    \path[pointer-left] (e-15.west) edge[in=20, out=160, looseness=1] (e-13.east);
    \path[pointer-right] (e-15.east) edge[bend right] (e-8.west);
    \path[pointer-left] (e-8.west) edge[bend right] (e-15.east);
    \path[pointer-right] (e-13.east) edge[in=-160, out=-20, looseness=1] (e-15.west);
    \path[pointer-left] (e-18.west) edge[in=20, out=160, looseness=7] (e-18.east);
    \path[pointer-right] (e-18.east) edge[in=-160, out=-20, looseness=7] (e-18.west);
    \path[pointer-left] (e-13.west) edge[bend right] (e-8.east);
    \path[pointer-right] (e-8.east) edge[bend right] (e-13.west);
    \path[pointer-left] (e-21.east) edge[bend right] (e-14.west);
    \path[pointer-right] (e-14.west) edge[bend right] (e-21.east);
    \path[pointer-left] (e-21.west) edge[in=20, out=160, looseness=2.5] (e-14.east);
    \path[pointer-right] (e-14.east) edge[in=-160, out=-20, looseness=2.5] (e-21.west);
    \path[pointer-left] (e-27.west) edge[in=20, out=160, looseness=7] (e-27.east);
    \path[pointer-right] (e-27.east) edge[in=-160, out=-20, looseness=7] (e-27.west);

    \draw[pointer-min] (e-7.north) -- ++(0, 0.5);
  \end{tikzpicture}
  \caption{\texttt{decreasekey($13$, $6$)}.}
\end{figure}
